...
def get_measurement_attention_mlp(batch_size=4, num_input_features=20, list_attention_shapes=[32,16,8]) :     # ✅ 원코드
# def get_measurement_attention_mlp(batch_size=4, num_input_features=20, input_size=256):
    # list_attention_shapes = [input_size // (2 ** (n + 3)) for n in range(3)]          # ✅ 수정코드
